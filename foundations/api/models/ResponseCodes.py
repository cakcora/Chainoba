...
class ResponseDescriptions(Enum):
    ...
    AddressInputMissing = "Value of Input Parameter address is missing."
    DateInputMissing = "Value of Input Parameter date is missing."
    InvalidDateFormat = "Value of Input Parameter is invalid. e.g. 2002-02-02 "
